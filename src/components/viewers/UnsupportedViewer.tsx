...
import { formatFileSize, getFileTypeName, type DocumentType } from '@/lib/types';
  ...
  return (
    <div className={cn('flex flex-col items-center justify-center h-full p-8', className)}>
      <div className="text-center max-w-md">
        {/* File icon */}
        <div className="mb-6 inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-muted">
          <svg
