...
export function ImageViewer({ fileUrl, fileName, className }: ImageViewerProps) {
  ...
  return (
    <div className={cn('flex flex-col h-full', className)}>
      ...
      {/* Image content */}
      <div className="flex-1 overflow-auto bg-[repeating-conic-gradient(#80808015_0%_25%,transparent_0%_50%)] bg-[length:20px_20px] flex items-center justify-center p-4">
        {error ? (
